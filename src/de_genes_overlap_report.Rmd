...
writingDir <- "~/Downloads/"
```

##Comparison: Trait A vs. Trait B

```{r loadDiffExpGeneLists}

targetPhenotypeName <- "Trait_of_Interest"

# Inputs must be character vectors/factors
deGenesRNA <- read.table("../test-data/differential-expression-genelist/diff-exp-genelist.txt")
